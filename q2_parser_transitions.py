class PartialParse(object):
    ...
    def parse_step(self, transition):
        ...
        if(transition == 'S' and len(self.buffer)>0):
            ...
            del (self.buffer)[0]
            #print('S:','A:',self.dependencies,'Stack:',self.stack,'Buffer:',self.buffer)
            
        elif(transition == 'LA' and len(self.stack)>1):
            dep_tuple = ((self.stack)[-1],(self.stack)[-2])
            (self.dependencies).append(dep_tuple)
            del (self.stack)[-2]
            #print('S:','A:',self.dependencies,'Stack:',self.stack,'Buffer:',self.buffer)

        elif(transition == 'RA' and len(self.stack)>1):
            dep_tuple = ((self.stack)[-2],(self.stack)[-1])
            (self.dependencies).append(dep_tuple)
            del (self.stack)[-1]
            #print('S:','A:',self.dependencies,'Stack:',self.stack,'Buffer:',self.buffer)
